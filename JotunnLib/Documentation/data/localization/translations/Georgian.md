...
|$button_x|X|
|$button_y|Y|
|$charredfortress|მოჯადოებული ტყე|
|$chat_entermessage|დაწერე რამე ჩატში|
...
|$enemy_skeleton_summoned|ჩონჩხი|
...
|$enemy_summonedroot|მოხმობილი ფესვი|
|$enemy_summonedtroll|მოხმობილი ტროლი|
...
|$fish10_description|ამ თევზს ყინულივით ცივი წყალი უყვარს.|
...
|$hud_snappoint_attach|მიმაგრება|
|$hud_snappoint_bottom|ქვემოთ|
|$hud_snappoint_center|ცენტრი|
|$hud_snappoint_corner|კუთხე|
|$hud_snappoint_edge|კიდე|
|$hud_snappoint_end|ბოლო|
|$hud_snappoint_inner|შიგნით|
|$hud_snappoint_mid|შუაში|
|$hud_snappoint_top|ზემოთ|
...
|$hud_wild|გარეული|
|$hud_zoom|მიახლოება|
|$hud_zoom_in_out|მიახლოება/დაშორება|
|$info_label|ინფორმაცია|
|$interface_leftarrow|<|
|$interface_rightarrow|>|
|$invalid_keybind_header|არასწორი ინფორმაცია|
...
|$piece_chest|გაძლიერებული ზარდახშა|
|$piece_chestblackmetal|Black Metal Chest|
|$piece_chestprivate|პერსონალური ზარდახშა|
|$piece_chesttreasure|Treasure Chest|
|$piece_chestwood|ზარდახშა|
